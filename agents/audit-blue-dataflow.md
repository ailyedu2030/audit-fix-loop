...
1. READ your briefing from `.audit-cache/briefings/blue_DATAFLOW.json`
...
6. Output to `.audit-cache/findings/blue_DATAFLOW.json`

## Rules
- causal_chain MUST have ≥3 entries
- root_cause must be ≥20 characters and NOT restate description
- Reference specific flow IDs from `.audit-cache/flow-trace.json` where applicable
